...
const PROXY_BASE = '';
const APP_ID = '6a0d67e1b854d612476be8fe';
...
export default function PublicFormTestererfassung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Testererfassung — Form</h1>
        </div>
